<?php $frontpage=false; $pagetitle="About"; $headertitle="About Steamchat"; ?>
	
	<?php include "../lib/header.php"; ?>
	
	<div id="wrapper">
		
		<h1><span style="width:150px;">Quick-links:</span> <a href="#history">History</a> <a href="#podcast">Podcast</a> <a href="#hosts">Hosts</a> <a href="#contact">Contact</a></h1>
		
		<h2 id="history">History</h2>
		
		<p style="font-weight:700;">Steamchat is a fan-made podcast that hosts discussions about Valve, Steam, digital distribution, PC games and other related subjects such as the art and design of video games and other topical video game related subjects.</p>
		
		<p>Steamchat was created in early June of 2009, born from the controversy of the Left 4 Dead 2 announcement at E3 of the same year. Since then, it has been maintained by the three hosts; Sam, Saurabh, and Brad. Steamchat has enjoyed considerable success in that time. In August of 2009, Steamchat hosted its <a href="http://www.thesteamchat.com/episodes/9/">first exclusive interview with Gabe Newell</a>, co-founder and managing director of Valve Software. Staying true to its aim of supporting the community, Steamchat allowed members of the community the opportunity to forward their own questions and concerns to Newell, resulting in an entirely community-produced interview. Since then, Steamchat has published a further six community-based interviews (including <a href="http://www.thesteamchat.com/episodes/47/">another with Newell</a>, <a href="http://www.thesteamchat.com/snacks/2/">Harry S. Robins</a>, <a href="http://www.thesteamchat.com/pages/portal2party/">Marc Laidlaw</a>, <a href="http://www.thesteamchat.com/pages/portal2party/">Al?sia Glidewell</a>, <a href="http://www.thesteamchat.com/pages/portal2party/">Ellen McLain</a>, <a href="http://www.thesteamchat.com/snacks/3/">Jonathan Coulton</a> and the <a href="http://www.thesteamchat.com/snacks/4/">Black Mesa mod team</a>).</p>
		...
		<p>Steamchat episodes are produced in audio-only format. Episodes last for around an hour in length. New episodes are released every week, usually on Wednesdays, and are published on <a href="http://www.thesteamchat.com">our website</a>, on two RSS feeds (<a href="http://www.thesteamchat.com/steamchat_feed_mp3.xml">MP3 feed</a> and <a href="http://www.thesteamchat.com/steamchat_feed.xml">M4A feed</a>), on the <a href="http://itunes.apple.com/WebObjects/MZStore.woa/wa/viewPodcast?id=320594165">iTunes Store</a> and on our <a href="http://www.youtube.com/">YouTube channel</a>.</p>
