<?php $frontpage=false; $episodepage=true; $pagetitle=$headertitle="Episode #68: Go Time" ?>
	...
	<div id="wrapper">
		...
		<span class="section">
			...
			<p>In this episode we discuss the announcement of Counter-Strike: Global Offensive, what it means for Valve, Half-Life, e-sports and more!</p>
		...
		<span class="section">
			...
			<div id="episode_audio_player">
				...
				<audio id="episode_audio"><source src="http://www.thesteamcast.com/episodes/68/steamcast_episode68.mp3" type="audio/mp3"></audio>
			...
			<ul style="clear:both;">
				...
				<li><a href="http://www.thesteamcast.com/episodes/68/steamcast_episode68.mp3">Direct MP3 Download</a></li>
