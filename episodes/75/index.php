<?php $frontpage=false; $episodepage=true; $pagetitle=$headertitle="Episode #75: Plush Flush" ?>
	...
	<div id="wrapper">
		...
		<span class="section">
			...
			<p>In this episode we discuss the upcoming Portal 2 in-game map editor, Counter-Strike: Global Offensive, and more!</p>
		...
		<span class="section">
			...
			<div id="episode_audio_player">
				...
				<audio id="episode_audio"><source src="http://www.thesteamchat.com/episodes/75/steamchat_episode75.mp3" type="audio/mp3"></audio>
			...
			<ul style="clear:both;">
				...
				<li><a href="http://www.thesteamchat.com/episodes/75/steamchat_episode75.mp3">Direct MP3 Download</a></li>
