<?php $frontpage=false; $episodepage=true; $pagetitle=$headertitle="Episode #5: Tea with Sasso" ?>
	...
	<div id="wrapper">
		...
		<span class="section">
			...
			<p>We're joined by Matt (Sasso from the forums) as we delve into his very own topic of "Episode Three wants and don't wants".</p>
		...
		<span class="section">
			...
			<div id="episode_audio_player">
				...
				<audio id="episode_audio"><source src="http://www.thesteamchat.com/episodes/5/steamchat_episode5.mp3" type="audio/mp3"></audio>
			...
			<ul style="clear:both;">
				...
				<li><a href="http://www.thesteamchat.com/episodes/5/steamchat_episode5.mp3">Direct MP3 Download</a></li>
