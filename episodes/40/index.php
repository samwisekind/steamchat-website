<?php $frontpage=false; $episodepage=true; $pagetitle=$headertitle="Episode #40: The Delay Is A Lie" ?>
	...
	<div id="wrapper">
		...
		<span class="section">
			...
			<p>This episode is already a month late, so typing a meaningful description for it would only make the delay longer!</p>
		...
		<span class="section">
			...
			<div id="episode_audio_player">
				...
				<audio id="episode_audio"><source src="http://www.thesteamchat.com/episodes/40/steamchat_episode40.mp3" type="audio/mp3"></audio>
			...
			<ul style="clear:both;">
				...
				<li><a href="http://www.thesteamchat.com/episodes/40/steamchat_episode40.mp3">Direct MP3 Download</a></li>
