<?php $frontpage=false; $episodepage=true; $pagetitle=$headertitle="Episode #100: Rise and Shine" ?>
	...
	<div id="wrapper">
		...
		<span class="section">
			...
			<p>Steamchat returns from the ashes as we catch up on a year of seperation, make our peace and get back to doing what we love - making this podcast.</p>
		...
		<span class="section">
			...
			<div id="episode_audio_player">
				...
				<audio id="episode_audio"><source src="http://www.thesteamchat.com/episodes/100/steamchat_episode100.mp3" type="audio/mp3"></audio>
			...
			<ul style="clear:both;">
				...
				<li><a href="http://www.thesteamchat.com/episodes/100/steamchat_episode100.mp3">Direct MP3 Download</a></li>
