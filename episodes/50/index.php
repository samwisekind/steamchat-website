<?php $frontpage=false; $episodepage=true; $pagetitle=$headertitle="Episode #50: Mid-Half-Life Crisis" ?>
	...
	<div id="wrapper">
		...
		<span class="section">
			...
			<p>In this episode, we are half way to the end... or are we? Topics include Portal 2, Gabe Newell and Dear Esther news.</p>
		...
		<span class="section">
			...
			<div id="episode_audio_player">
				...
				<audio id="episode_audio"><source src="http://www.thesteamcast.com/episodes/50/steamcast_episode50.mp3" type="audio/mp3"></audio>
			...
			<ul style="clear:both;">
				...
				<li><a href="http://www.thesteamcast.com/episodes/50/steamcast_episode50.mp3">Direct MP3 Download</a></li>
