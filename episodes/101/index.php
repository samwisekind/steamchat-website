<?php $frontpage=false; $episodepage=true; $pagetitle=$headertitle="Episode #101: Pacific Podcast" ?>
	...
	<div id="wrapper">
		...
		<span class="section">
			...
			<p>In this episode we discuss Amnesia: A Machine for Pigs, making choices in video games, and briefly touch on Pacific Rim.</p>
		...
		<span class="section">
			...
			<div id="episode_audio_player">
				...
				<audio id="episode_audio"><source src="http://www.thesteamcast.com/episodes/101/steamcast_episode101.mp3" type="audio/mp3"></audio>
			...
			<ul style="clear:both;">
				...
				<li><a href="http://www.thesteamcast.com/episodes/101/steamcast_episode101.mp3">Direct MP3 Download</a></li>
