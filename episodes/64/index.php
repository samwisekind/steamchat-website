<?php $frontpage=false; $episodepage=true; $pagetitle=$headertitle="Episode #64: Free to Listen" ?>
	...
	<div id="wrapper">
		...
		<span class="section">
			...
			<p>In this episode we discuss the ground-breaking news of Team Fortress 2's new free-to-play direction, Meet the Medic and more.</p>
		...
		<span class="section">
			...
			<div id="episode_audio_player">
				...
				<audio id="episode_audio"><source src="http://www.thesteamcast.com/episodes/64/steamcast_episode64.mp3" type="audio/mp3"></audio>
			...
			<ul style="clear:both;">
				...
				<li><a href="http://www.thesteamcast.com/episodes/64/steamcast_episode64.mp3">Direct MP3 Download</a></li>
