<?php $frontpage=false; $episodepage=true; $pagetitle=$headertitle="Episode #60: Up In Your SDK" ?>
	...
	<div id="wrapper">
		...
		<span class="section">
			...
			<p>In this episode we discuss Daily Deals, Valve's presence at E3 and the secrets that await us in the Portal 2 SDK.</p>
		...
		<span class="section">
			...
			<div id="episode_audio_player">
				...
				<audio id="episode_audio"><source src="http://www.thesteamchat.com/episodes/60/steamchat_episode60.mp3" type="audio/mp3"></audio>
			...
			<ul style="clear:both;">
				...
				<li><a href="http://www.thesteamchat.com/episodes/60/steamchat_episode60.mp3">Direct MP3 Download</a></li>
