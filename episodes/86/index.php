<?php $frontpage=false; $episodepage=true; $pagetitle=$headertitle="Episode #86: Red Letter Day" ?>
	...
	<div id="wrapper">
		...
		<span class="section">
			...
			<p>In this episode we discuss the Steam Mobile App, the latest Black Mesa Source news, and have a chat with Surfrock22 about the 'A Red Letter Day' event.</p>
		...
		<span class="section">
			...
			<div id="episode_audio_player">
				...
				<audio id="episode_audio"><source src="http://www.thesteamcast.com/episodes/86/steamcast_episode86.mp3" type="audio/mp3"></audio>
			...
			<ul style="clear:both;">
				...
				<li><a href="http://www.thesteamcast.com/episodes/86/steamcast_episode86.mp3">Direct MP3 Download</a></li>
