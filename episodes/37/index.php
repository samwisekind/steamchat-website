<?php $frontpage=false; $episodepage=true; $pagetitle=$headertitle="Episode #37: Worst Thing Evah" ?>
	...
	<div id="wrapper">
		...
		<span class="section">
			...
			<p>We revisit the topics from last week, but with more perspectives from the community.</p>
		...
		<span class="section">
			...
			<div id="episode_audio_player">
				...
				<audio id="episode_audio"><source src="http://www.thesteamchat.com/episodes/37/steamchat_episode37.mp3" type="audio/mp3"></audio>
			...
			<ul style="clear:both;">
				...
				<li><a href="http://www.thesteamchat.com/episodes/37/steamchat_episode37.mp3">Direct MP3 Download</a></li>
