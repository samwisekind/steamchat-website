...
<p>Steamchat is an audio-only podcast, with episodes lasting for around an hour in length. New episodes are published on <a href="<?php echo $hostLocation; ?>">our website</a>, on our <a href="<?php echo $hostLocation; ?>/steamchat_feed_mp3.xml">RSS feed</a>, and on the <a href="http://itunes.apple.com/WebObjects/MZStore.woa/wa/viewPodcast?id=320594165">iTunes Store</a>.</p>
...
<p>You can view a list of <a href="<?php echo $hostLocation; ?>specials/">our interviews and special episodes here</a>.</p>
